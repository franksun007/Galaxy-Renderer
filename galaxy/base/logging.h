...
#define _GALAXY_LOG_FATAL \
  ::galaxy::LogMessageFatal(__FILE__, __LINE__)
...
#define CHECK_OP_LOG(name, op, val1, val2)                            \
  while (::galaxy::CheckOpString _result =              \
             ::galaxy::name##Impl(                      \
                 ::galaxy::GetReferenceableValue(val1), \
                 ::galaxy::GetReferenceableValue(val2), \
                 #val1 " " #op " " #val2))                            \
...
#define CHECK_NOTNULL(val)                                 \
  ::galaxy::CheckNotNull(__FILE__, __LINE__, \
